...
// var fruitsAndVeggies = [...fruits,...vegetables];
...
// console.log(countVowels('BoatCountFlop'));
...
function removeVowels(letter){
    var removed = letter.replace(/[aeiou]/gi, '');
    return removed;
}


// console.log(removeVowels('MoveYourCatAway'));
...
// console.log(startsWithVowel('Away'));
// console.log(startsWithVowel('Crop'));
...
function endsWithVowel(str){
    var myString = str.length;
    var lastLetter = str.charAt(myString-1).toLowerCase();
