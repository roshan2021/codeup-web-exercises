...
var helloMessage =  sayHello("Part 2 Roshan");
console.log(helloMessage);

helloMessage = sayHello("Part 2 Codeup");
console.log(helloMessage);

helloMessage = sayHello("Part 2 Apex");
...
// var tipTotal = calculateTip( (percentage / 100), bill);
